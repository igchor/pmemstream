...
function(execute_common expect_success output_file name)
	...
	if(${TRACER} STREQUAL pmemcheck)
		set(ENV{LIBPMEMSTREAM_TRACER_PMEMCHECK} 1)
		if(TESTS_USE_FORCED_PMEM)
	...
	elseif(${TRACER} STREQUAL memcheck)
		set(ENV{LIBPMEMSTREAM_TRACER_MEMCHECK} 1)
	...
	set(ENV{LIBPMEMSTREAM_TRACER_GDB} 1)
	...
	if(${TRACER} STREQUAL pmemcheck)
		unset(ENV{LIBPMEMSTREAM_TRACER_PMEMCHECK})
	elseif(${TRACER} STREQUAL memcheck)
		unset(ENV{LIBPMEMSTREAM_TRACER_MEMCHECK})
	elseif(${TRACER} STREQUAL helgrind)
		unset(ENV{LIBPMEMSTREAM_TRACER_HELGRIND})
	elseif(${TRACER} STREQUAL drd)
		unset(ENV{LIBPMEMSTREAM_TRACER_DRD})
	elseif(${TRACER} STREQUAL gdb)
		unset(ENV{LIBPMEMSTREAM_TRACER_GDB})
	endif()
